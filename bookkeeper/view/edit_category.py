"""
Реализация виджета для редактирования категорий расходов
"""
...
class WidgetEditCategory(QtWidgets.QWidget):
    ...
    def __init__(self,
        ...
        # Дерево категорий
        label_cats = WidgetName("<b>Список категорий</b>")

        self.category_tree = QtWidgets.QTreeWidget()
        self.category_tree.setHeaderLabel("")
        self.category_tree.itemDoubleClicked.connect(self._dclick)
        ...
        self.dbtn.clicked.connect(self._delete)

        # Добавление категории
        add_label = WidgetName("<b>Добавление категории</b>")
        ...
        self.abtn.clicked.connect(self.add)
